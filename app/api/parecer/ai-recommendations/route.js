...
${temIncome ? `- O campo "renda" traz a renda líquida do contracheque (ou estimativa) do mês anterior. Inclua OBRIGATORIAMENTE uma recomendação específica sobre como redistribuir os gastos por categoria (campo "gastos_por_categoria") em relação a essa renda para maximizar quanto pode ser investido — aponte quais categorias têm mais espaço para corte, com valores/percentuais concretos, e quanto isso liberaria por mês e por ano se investido.` : ''}
