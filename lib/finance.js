...
export const CAT_COLORS = {
  'Alimentação': '#C1562E',
  'Assinaturas': '#B98A2E',
  'Saúde & Cuidado Pessoal': '#2F6F5E',
  'Transporte': '#5B6B62',
  'Compras & Mercado': '#7F77DD',
  'Anuidade': '#993C1D',
  'IOF/Tarifas': '#888780',
  'Pagamento Fatura': '#639922',
  'Outros': '#B4B2A9',
};
...
export function parseLines(text, period, overrides = {}) {
  ...
  while (i < lines.length) {
    ...
    if (direct) {
      out.push({
        ...
        value: direct.value,
        category: categorize(direct.description, overrides),
      });
      i++;
      continue;
    }
