...
// deve ser o líquido do contracheque cujo período é o MESMO anchorPeriod de
// `analysis` (não um período deslocado): o salário recebido no fim do mês M
// é o que financia as parcelas que já vencem em M+1, que é exatamente o que
// `nextCommitted` representa — a responsabilidade de achar esse contracheque
// certo (por período == anchorPeriod) é de quem chama esta função.
